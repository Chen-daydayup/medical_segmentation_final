...
|------|------------|-------------|------------|
| UNet | 4.90 | 0.8659 | 0.7922 |
| ResUNet | 5.14 | 0.8760 | 0.8003 |
| UNet++ | 6.21 | 0.8748 | 0.8023 |
| ResUNet++ | 6.57 | 0.8751 | 0.8010 |
| **ResUNet++-Transformer** | 8.28 | **0.9036** | **0.8387** |
...
| 模型 | Dice | IoU | Recall |
|------|------|-----|--------|
| UNet | 0.4167 | 0.3573 | 0.4541 |
| ResUNet | 0.4369 | 0.3768 | 0.4963 |
| UNet++ | 0.3963 | 0.3424 | 0.4157 |
| ResUNet++ | 0.3718 | 0.3164 | 0.4194 |
| **ResUNet++-Transformer** | **0.4949** | **0.4237** | **0.6105** |

#### CVC-ColonDB 测试集
| 模型 | Dice | IoU | Recall |
|------|------|-----|--------|
| UNet | 0.5982 | 0.5214 | 0.5935 |
| ResUNet | 0.6246 | 0.5410 | 0.6615 |
| UNet++ | 0.6158 | 0.5331 | 0.6166 |
| ResUNet++ | 0.6100 | 0.5219 | 0.6648 |
| **ResUNet++-Transformer** | **0.6934** | **0.6099** | **0.7114** |
