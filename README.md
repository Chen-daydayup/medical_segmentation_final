...
|------|------------|-------------|------------|
| UNet | 4.90 | 0.8751 | 0.8013 |
| ResUNet | 5.14 | 0.8770 | 0.8030 |
| UNet++ | 6.21 | 0.8782 | 0.8038 |
| ResUNet++ | 6.57 | 0.8773 | 0.8049 |
| **ResUNet++-Transformer** | 8.28 | **0.8982** | **0.8322** |
...
| 模型 | Dice | IoU | Recall |
|------|------|-----|--------|
| UNet | 0.4648 | 0.3968 | 0.5165 |
| ResUNet | 0.4321 | 0.3621 | 0.4823 |
| UNet++ | 0.4358 | 0.3536 | 0.5740 |
| ResUNet++ | 0.4225 | 0.3583 | 0.5040 |
| **ResUNet++-Transformer** | **0.5436** | **0.4609** | **0.6208** |

#### CVC-ColonDB 测试集
| 模型 | Dice | IoU | Recall |
|------|------|-----|--------|
| UNet | 0.6390 | 0.5425 | 0.6914 |
| ResUNet | 0.6280 | 0.5453 | 0.6443 |
| UNet++ | 0.5845 | 0.5113 | 0.6244 |
| ResUNet++ | 0.6263 | 0.5454 | 0.6297 |
| **ResUNet++-Transformer** | **0.6607** | **0.5859** | **0.6615** |
